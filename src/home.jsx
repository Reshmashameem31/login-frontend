  ...
  return (
    <>
      <div className="relative min-h-screen flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col md:flex-col justify-between items-center bg-white/90 shadow-xl rounded-2xl p-4 md:p-8 w-full mt-4 mb-4 max-w-sm md:max-w-xl">
          <h1 className="text-4xl font-extrabold text-yellow-500 mb-4 md:mb-0">
            📚 Book Finder
          </h1>
          <button
            onClick={handleLogout}
            className="bg-yellow-500 hover:bg-yellow-600 text-white  mt-2 px-5 py-2 rounded-xl shadow-md transition"
          >
            Logout
          </button>
           <p className="text-amber-900 text-lg mt-4">
